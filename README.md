...
A modern, interactive vocabulary learning app for HSK Level 4 Chinese words, featuring English and Bengali translations.
...
- [Alpine.js](https://alpinejs.dev/) — Lightweight JavaScript framework (via CDN)

## Getting Started

1. Clone the repository:
   ```bash
   git clone https://github.com/Tanvir-yzu/HSK4-Vocabulary.git
   ```
